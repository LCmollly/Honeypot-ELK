...
4.2	DESPLIEGUE DEL HONEYPOT
En esta sección se detallará el proceso de instalación y configuración del software elegido para implementar el honeypot IoT, "Cowrie" [8].
